        ...
        <div ref = {homeRef}className = "flex-col flex items-center w-full ">
          <div className = "flex mt-12 justify-center w-full">
            <div className = "mt-12 w-4/12 flex-col flex gap-2">
              ...
              <a className = "bg-[#102240] font-rubik text-white w-fit text-md rounded-md  text-sm p-3 transition-colors duration-300 ease-in-out hover:bg-white hover:text-black " href = {resume} download> Download Resume</a>
            </div>
